                ...
                <div class="mb-3">
                    ...
                    <div class="time-input-group">
                        ...
                        <select name="contact_period" class="form-select">
                            <option value="AM" <?= (isset($_POST['contact_period']) && $_POST['contact_period'] === 'AM') ? 'selected' : '' ?>>AM</option>
                            <option value="PM" <?= (isset($_POST['contact_period']) && $_POST['contact_period'] === 'PM') ? 'selected' : 'selected' ?>>PM</option>
                        </select>
                    </div>
                </div>
