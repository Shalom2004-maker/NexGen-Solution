...
<body>
    ...
    <nav class="navbar-section">
        <a href="#" class="navbar-brand">
            <i class="bi bi-building"></i> NexGen Solution
        </a>
    ...
    <section class="hero-section">
        ...
        <p>The all-in-one platform for task management, payroll processing, and leave tracking. Built for modern enterprises that value efficiency.</p>
